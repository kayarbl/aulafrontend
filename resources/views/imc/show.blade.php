        ...
        <tbody>
            @foreach($showImc as $imc)
                    <tr>
                        ...
                        <td>{{$imc->altura}}</th>
                        <td>
                            <form id="deleteForm{{$imc->id}}" action="{{ route(
                    'imc.delete',
                    ['id' => $imc->id]
                ) }}" method="POST">
                                @csrf
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExempleInput" palceholder="nome"
                                            name="novo_nome">
                                    </div>

                                    <div class="mb-3">
                                        <label for="formGroupExempleInput" class="form-label">Peso</label>
                                        <input type="text" class="form-control" id="formGroupExempleInput" palceholder="peso"
                                            name="novo_peso">
                                    </div>

                                    <div class="mb-3">
                                        <label for="formGroupExempleInput2" class="form-label">Altura</label>
                                        <input type="text" class="form-control" id="formGroupExempleInput" palceholder="altura"
                                            name="novo_altura">
                                    </div>
